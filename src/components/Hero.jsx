  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        {heroSlides.map((slide, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center z-30">
              <h2
                className={`text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-[100px] font-serif opacity-70 -mt-8 sm:-mt-12 md:-mt-16 transition-all duration-600 delay-300 ml-2 sm:ml-4 md:ml-8 ease-in-out transform ${
      ...
      <button
        ...
        className="absolute left-2 sm:left-4 top-1/2 transform -translate-y-1/2 z-30 bg-black bg-opacity-50 hover:bg-opacity-75 text-white p-2 rounded-full transition-all duration-200"
      >
        <svg
          className="w-6 h-6"
          fill="none"
